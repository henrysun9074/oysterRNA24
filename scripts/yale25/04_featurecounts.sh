...
#SBATCH --output=/work/clh162/henry/logs/yale25_featureCounts_gtf_%A.out
#SBATCH --error=/work/clh162/henry/logs/yale25_featureCounts_gtf_%A.err
...
BAM_DIR=/work/clh162/henry/results/yale25/aligned_bam
