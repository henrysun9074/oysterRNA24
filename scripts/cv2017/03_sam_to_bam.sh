#!/bin/bash -e
#SBATCH --job-name=CV2017_sam_to_bam_array
#SBATCH --time=7-00:00:00
#SBATCH --array=1-18
#SBATCH --output=/work/clh162/henry/logs/CV2017_sam_to_bam_array_%A_%a.out
#SBATCH --error=/work/clh162/henry/logs/CV2017_sam_to_bam_array_%A_%a.err
...
## Set Paths ##
SAM_DIR=/work/clh162/henry/results/cv2017/aligned
