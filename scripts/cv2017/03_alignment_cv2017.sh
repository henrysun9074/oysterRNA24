#!/bin/bash -e
#SBATCH --job-name=CV2017_alignment_array
#SBATCH --time=7-00:00:00
#SBATCH --array=1-18
#SBATCH --output=/work/clh162/henry/logs/CV2017_alignment_array_%A_%a.out
#SBATCH --error=/work/clh162/henry/logs/CV2017_alignment_array_%A_%a.err
...
ALIGNED_DIR=/work/clh162/henry/results/cv2017/aligned
mkdir -p ${ALIGNED_DIR} 
...
hisat2 \
    ...
    -x ${INDEX_DIR}/c.virginica_2017_HFM_index \
    -1 ${R1} \
    -2 ${R2} \
